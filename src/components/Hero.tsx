...
const Hero = () => {
  return (
    <section id="hero" className="pt-16 pb-20 px-4 sm:px-6 lg:px-8 relative" aria-label="Introduction">
      <div className="max-w-7xl mx-auto">
        <div className="text-center relative z-10">
          <div className="mb-8">
            <div className="relative">
              <div className="w-32 h-32 mx-auto bg-gradient-to-br from-cyan-500 via-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white text-4xl font-bold mb-6 animate-float shadow-2xl ring-4 ring-blue-200/50 dark:ring-blue-700/50" role="img" aria-label="Dawit Gulta's avatar with initials DG">
                DG
              </div>
              {/* Tech sparkles around avatar */}
              <div className="absolute -top-2 -left-2 w-4 h-4 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full animate-ping" aria-hidden="true"></div>
              <div className="absolute -bottom-2 -right-2 w-3 h-3 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full animate-ping animation-delay-2000" aria-hidden="true"></div>
              <div className="absolute top-8 -right-4 w-2 h-2 bg-gradient-to-r from-emerald-400 to-teal-500 rounded-full animate-pulse animation-delay-4000" aria-hidden="true"></div>
            </div>
          </div>
          ...
          <div className="flex justify-center space-x-6">
            <a
              ...
              className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 rounded"
